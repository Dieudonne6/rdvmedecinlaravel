                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a href="{{ route('inscripdocteur') }}" class="nav-link active">Inscription</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('connexdocteur') }}" class="nav-link">Connexion</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="signup-item">
                        <div class="signup-head">
                            ...
                            <p>Avez-vous un compte?
                                <a href="{{ route('connexdocteur') }}">connexion</a>
                            </p>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <label>Choisisser votre domaine</label>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="gridCheck">
                                                    Oui, j'accepte les <a href="#">Termes & Conditions</a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="text-center">
                                            <button type="submit" class="btn signup-btn">Inscription</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
