                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        ...
                        <div class="nav-srh">
                            ...
                            {{-- @if(auth()->guard('docteur')->check() && auth()->guard('docteur')->user() !== null)
        <p style="font-weight: bold; margin-left: 30px; margin-bottom:-2px;">Docteur {{ auth()->guard('docteur')->user()->name }} </p>
    @endif --}}
                        {{-- <p style="font-weight: bold; margin-left: 30px; margin-bottom:-2px;">Docteur {{ auth()->guard('docteur')->user()->name }} </p> --}}

                        <p style="font-weight: bold; margin-left: 30px; margin-bottom:-2px;">Docteur 
                            {{-- @if(auth()->guard('docteur')->check() && auth()->guard('docteur')->user() !== null) --}}
...
{{--  --}}
    ...
    <a href="{{ route('connexdocteur') }}" class="btn btn-primary">Connexion</a>
@endguest
