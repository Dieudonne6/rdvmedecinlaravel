                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('inscripdocteur') }}" class="nav-link">Inscription</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('connexdocteur') }}" class="nav-link active">Connexion</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="signup-item">
                        <div class="signup-head">
                            ...
                            <p>Vous n'avez pas de compte?
                                <a href="{{ route('inscripdocteur') }}">Inscrivez-vous</a>
                            </p>
                        </div>
