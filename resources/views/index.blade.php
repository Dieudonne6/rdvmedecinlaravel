...
<!-- Mirrored from templates.hibootstrap.com/medsev/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Oct 2023 17:13:26 GMT -->
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link dropdown-toggle">Inscription</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="{{ route('inscrippatient') }}" class="nav-link">Patient</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('inscripdocteur') }}" class="nav-link">Docteur</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link dropdown-toggle">Connexion</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="{{ route('connexpatient') }}" class="nav-link">Patient</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('connexdocteur') }}" class="nav-link">Docteur</a>
                                    </li>
                                </ul>
                            </li>
    ...
    <div class="container">
        <div class="copyright-item">
            <p>Copyright @
                ...
                </script> Medsev. Designed By <a href="https://hibootstrap.com/"
...
<!-- Mirrored from templates.hibootstrap.com/medsev/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Oct 2023 17:13:42 GMT -->
