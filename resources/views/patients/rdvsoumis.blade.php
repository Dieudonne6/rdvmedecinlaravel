                ...
                <div class="testimonial-wrap">
                    ...
                    <div class="testimonial-slider owl-theme owl-carousel">
                        <div class="testimonial-item">
                            ...
                            <h3>Cher patient {{ auth()->user()->name }}</h3>
                            <p>Nous vous remercions pour votre demande de rendez-vous. Votre requête a bien été enregistrée
                                dans notre système. Nous accordons une attention particulière à chaque demande et nous nous
                                efforçons de répondre à toutes les demandes dans les meilleurs délais.Restez à l'écoute, car
                                nous vous contacterons prochainement par e-mail pour confirmer les détails de votre.Si vous
                                avez des questions supplémentaires ou si vous avez besoin de plus d'informations, n'hésitez
