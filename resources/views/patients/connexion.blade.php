                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('inscrippatient') }}" class="nav-link">Inscription</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('connexpatient') }}" class="nav-link active">Connexion</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="signup-item">
                        <div class="signup-head">
                            ...
                            <p>Vous n'avez pas de compte?
                                <a href="{{ route('inscrippatient') }}">Inscrivez-vous</a>
                            </p>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-center">
                                            <button type="submit" class="btn signup-btn">Connexion</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
