                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a href="{{ route('inscrippatient') }}" class="nav-link active">Inscription</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('connexpatient') }}" class="nav-link">Connexion</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="signup-item">
                        <div class="signup-head">
                            ...
                            <p>Avez-vous un compte?
                                <a href="{{ route('connexpatient') }}">connexion</a>
                            </p>
                        </div>
